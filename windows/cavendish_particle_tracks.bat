...
:: If you are feeling creative, you can also change the icon of the shortcut to the Cavendish logo (C:\Program Files\Python311\Lib\site-packages\cavendish_particle_tracks\docs\ParticleCrocodile.png)
@echo off
if not exist "%userprofile%\.napari" mkdir  %userprofile%\.napari
set PYTHON_ROOT=C:\Program Files\Python311
