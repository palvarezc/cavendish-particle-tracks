...
class StereoshiftInfo:
    ...
    def __str__(self):
        ...
        mystring += f"sf1=[{self._sf1[0]} {self._sf1[1]}]; "
        mystring += f"sf2=[{self._sf2[0]} {self._sf2[1]}]; "
        mystring += f"sp1=[{self._sp1[0]} {self._sp1[1]}]; "
        mystring += f"sp2=[{self._sp2[0]} {self._sp2[1]}]; "
